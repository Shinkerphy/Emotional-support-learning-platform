...
from models import efficientnet_b0, efficientnet_b1, efficientnet_b2, efficientnet_b3, efficientnet_b4, efficientnet_b5, efficientnet_b6, efficientnet_b7
...
if config['model_type'] == 'efficientnet_b0':
    model = efficientnet_b0(num_classes=7).to(device)
elif config['model_type'] == 'efficientnet_b1':
    model = efficientnet_b1(num_classes=7).to(device)
elif config['model_type'] == 'efficientnet_b2':
    model = efficientnet_b2(num_classes=7).to(device)
elif config['model_type'] == 'efficientnet_b3':
    model = efficientnet_b3(num_classes=7).to(device)
elif config['model_type'] == 'efficientnet_b4':
    model = efficientnet_b4(num_classes=7).to(device)
elif config['model_type'] == 'efficientnet_b5':
    model = efficientnet_b5(num_classes=7).to(device)
elif config['model_type'] == 'efficientnet_b6':
    model = efficientnet_b6(num_classes=7).to(device)
elif config['model_type'] == 'efficientnet_b7':
    model = efficientnet_b7(num_classes=7).to(device)
else:
    raise ValueError("Invalid model_type in config. Choose from 'efficientnet_b0' to 'efficientnet_b7'.")
