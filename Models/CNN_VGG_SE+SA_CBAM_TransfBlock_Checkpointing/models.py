...
class EmotionCNN(nn.Module):
    ...
    def forward(self, x):
        x = self.vgg_block1(x)
        x = self.vgg_block2(x)
        x = checkpoint(self.self_attention1, x, use_reentrant=False)
        x = checkpoint(self.cbam1, x, use_reentrant=False)
        x = checkpoint(self.transformer1, x, use_reentrant=False)
        
        x = self.vgg_block3(x)
        x = checkpoint(self.self_attention2, x, use_reentrant=False)
        x = checkpoint(self.cbam2, x, use_reentrant=False)
        x = checkpoint(self.transformer2, x, use_reentrant=False)
        
        x = self.vgg_block4(x)
        x = self.vgg_block5(x)
        x = checkpoint(self.self_attention3, x, use_reentrant=False)
        x = checkpoint(self.cbam3, x, use_reentrant=False)
        x = checkpoint(self.transformer3, x, use_reentrant=False)
